...
class MotionDetector(PMW3360DM):
    ...
    def read_sensor(self, buff):
        self.read_pos_buff(buff)
        #self.delta[1] = int.from_bytes(self.motionBuffer[:2], 'little')
        #self.delta[0] = int.from_bytes(self.motionBuffer[2:], 'little')

    def _timer_ISR(self, t):
        # Read a sample to the buffer, update write index.
        #self.read_pos_buff(self.motionBuffer)
        self.buffers[self.write_buffer][self.write_index] = int.from_bytes(self.motionBuffer[0:1],'little')
